...
import styles from '../../css/bookings/bookinguser';
                    ...
                    <View>
                        ...
                        <View style={[styles.bg_area_book, { backgroundColor: COLOURS.blue }]}>
                            <View style={styles.arrow_area}>
                                ...
                                <Text style={[styles.acc_name, { color: COLOURS.white }]}>About Handyman</Text>
                            </View>
                        </View>
                            ...
                            <View style={styles.row_area}>
                                ...
                                <View style={styles.name_icon_area}>
                                    <View style={styles.name_icon}>
                                        <Text style={[styles.name_demo_text, { color: theme.colorwhite }]}>{booking_user?.handyman}</Text>
                                    </View>
                                    <View>
