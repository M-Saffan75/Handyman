...
import { all_items } from '../../Backend/data';
...
const Favourites_Services = () => {
    ...
    const onClickItem = (item) => {
        navigation.navigate('Favourite_Service_Details', { id: item.id })
    }
                ...
                <View style={[styles.container, { backgroundColor: theme.backgroundColor }]}>
                    ...
                    <View>
                        <View style={styles.arrow_area}>
                            ...
                            <Text style={[styles.acc_name, { color: theme.colorwhite }]}>Favourite Services</Text>
                        </View>
                    </View>

                    <View style={styles.space_manage}></View>
                    <FlatList
                        // data={favourites_services}
                        data={all_items}
...
export default Favourites_Services