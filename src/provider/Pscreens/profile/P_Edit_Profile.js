        ...
        <>
            ...
            <ScrollView style={[styles.container, { backgroundColor: theme.backgroundColor }]} showsVerticalScrollIndicator={false}>
                ...
                <View style={[styles.pswd_inpt_container, { backgroundColor: theme.lightblack }]}>
                    <TextInput placeholder='' defaultValue='demo' placeholderTextColor={COLOURS.grey} style={[styles.pswd_inpt, { color: theme.colorwhite }]} />
                ...
                <View style={[styles.pswd_inpt_container, { backgroundColor: theme.lightblack }]}>
                    <TextInput placeholder='' defaultValue='demo88' placeholderTextColor={COLOURS.grey} style={[styles.pswd_inpt, { color: theme.colorwhite }]} />
                ...
                <View style={[styles.pswd_inpt_container, { backgroundColor: theme.lightblack }]}>
                    <TextInput placeholder='' defaultValue='demo@gmail.com' placeholderTextColor={COLOURS.grey} style={[styles.pswd_inpt, { color: theme.colorwhite }]} />
                ...
                <View style={styles.row_name}>
                    ...
                    {/* <Text style={[styles.your_name_two, { color: theme.colorwhite }]}> Country</Text> */}
                    {/* <Text style={[styles.your_name_one, { color: theme.colorwhite }]}> states</Text> */}

                </View>

                <View style={styles.city_state_area}>
                ...
                {/* <Text style={[styles.your_name, { color: theme.colorwhite }]}> your country</Text> */}
                ...
                <TouchableOpacity style={styles.row_lang_here} activeOpacity={0.7}>
                    <Text style={[styles.lang_1, { backgroundColor: theme.lightblack, color: COLOURS.green }]}>add known languages</Text>
                </TouchableOpacity>

                <View style={styles.more_handyman}>
                    <Text style={[styles.more_handyman_text, { color: theme.colorwhite }]}>about you*</Text>
                </View>

                <View style={[styles.textAreaContainer, { borderColor: theme.colorblue, }]}>
                    <TextInput
                        placeholder='About You'
                        defaultValue='Hard working with several years of experience and others services ...💐'
