            ...
            <ScrollView showsVerticalScrollIndicator={false} style={styles.container}>
                ...
                <View style={styles.short_container}>
                    <View style={styles.name_line}>
                        <Text style={styles.login_name}>Your Email</Text>
                    ...
                    <TouchableOpacity activeOpacity={0.6} style={styles.login_here_btn} onPress={() => navigation.replace('Otp')}>
                        <Text style={styles.login_here}>Send Email </Text>
                    </TouchableOpacity>
                </View>
